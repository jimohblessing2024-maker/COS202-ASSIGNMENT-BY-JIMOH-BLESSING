...
1.  Using PYTHON programming language, develop an interactive and well-designed screen MATHEMATICAL CALCULATOR (MC) programme containing components such as +, -, /, \\, *, ^, %, C (Clear), OFF etc. (NB: It’s a simple calculator not complex scientific one).

2.  CGPA is not something that should constrain you to visiting AVERS at all time – this is something you can have inside your pocket and carry all around, running and checking it at your will. Using the powerful provision of selection control statements in PYTHON, develop a PERSONAL POCKET CGPA Calculator (PPC).
